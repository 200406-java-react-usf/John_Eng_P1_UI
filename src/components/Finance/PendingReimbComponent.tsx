...
const PendingReimbComponent = (props: IPendingReimbProps)=> {
    ...
    let pendingCheck = (x: ERSreimb) => {
        return ((x.REIMB_STATUS == "PENDING"));
    }
    ...
    <Table className={classes.table} aria-label="simple table">
      ...
      <TableBody>
        {userData1.filter(pendingCheck).map((row) => (
  ...
  export default PendingReimbComponent;